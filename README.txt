Travel Planner Agent using LangGraph and Tool-Driven AI Orchestration

The flow:-When user asks a qusetion,it checks if query is relevant.If query isrelevant then it will call planner agent.
